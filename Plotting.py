...
Filename="D:\\Klaas\\Tweezers\\Python Scripts\\NonEquilibriumModel\\15x167 FC1_data_006_40_refoldingb.fit"
Headers,Data = Tools.read_data(Filename)
LogFile=Tools.read_log(Filename[:-15]+'.log')
...
#PossibleStates =np.array([Lmin,Lmax,Lc])
